...
abstract UInt16(Int) to Int {
	...
	public static inline var MAX:Int = 0xFFFF;
	...
	inline public function new(i:Int) 
	{
		...
		#elseif debugPeoteIO			
			if (i < MIN || i > MAX) throw('Error: Int $i did not fit into UInt16');
			this = i;			
		#else			
			this = i;			
		#end
	...
	@:from static public inline function fromInt(i:Int) return new UInt16(i);
